...
\item 
\textbf{ cpu\+\_\+architecture\+\_\+t} \textbf{ architecture}
\item 
...
\item 
int32\+\_\+t \textbf{ l1\+\_\+data\+\_\+instances}
\item 
int32\+\_\+t \textbf{ l1\+\_\+instruction\+\_\+instances}
\item 
int32\+\_\+t \textbf{ l2\+\_\+instances}
\item 
int32\+\_\+t \textbf{ l3\+\_\+instances}
\item 
int32\+\_\+t \textbf{ l4\+\_\+instances}
\item 
char \textbf{ cpu\+\_\+codename} [CODENAME\+\_\+\+STR\+\_\+\+MAX]
\item 
...
\item 
\textbf{ cpu\+\_\+affinity\+\_\+mask\+\_\+t} \textbf{ affinity\+\_\+mask}
\item 
\textbf{ cpu\+\_\+purpose\+\_\+t} \textbf{ purpose}
...
\label{structcpu__id__t_abef0af49ab2bc79c2edd1a77e780f7fa} 
\index{cpu\_id\_t@{cpu\_id\_t}!affinity\_mask@{affinity\_mask}}
\index{affinity\_mask@{affinity\_mask}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{affinity\_mask}
{\footnotesize\ttfamily \textbf{ cpu\+\_\+affinity\+\_\+mask\+\_\+t} cpu\+\_\+id\+\_\+t\+::affinity\+\_\+mask}

bitmask of the affinity ids this processor type is occupying \label{structcpu__id__t_a8e3190ec41fbc2c4ac2f44488d6cac7d} 
\index{cpu\_id\_t@{cpu\_id\_t}!architecture@{architecture}}
\index{architecture@{architecture}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{architecture}
{\footnotesize\ttfamily \textbf{ cpu\+\_\+architecture\+\_\+t} cpu\+\_\+id\+\_\+t\+::architecture}

contains the CPU architecture ID (e.\+g. ARCHITECTURE\+\_\+\+X86) \label{structcpu__id__t_a06aa6176f92acfe849e7a73583d1f43e} 
...
contains the brand string, e.\+g. \"{}\+Intel(\+R) Xeon(\+TM) CPU 2.\+40\+GHz\"{} \label{structcpu__id__t_a87a575a3b3ed39a7404a0205654a1e9a} 
...
{\footnotesize\ttfamily char cpu\+\_\+id\+\_\+t\+::cpu\+\_\+codename[CODENAME\+\_\+\+STR\+\_\+\+MAX]}
...
\end{DoxyCode}
 \label{structcpu__id__t_a9ff2b61f549cd224f283c49bc8bbe865} 
...
Hints 
\end{DoxySeeAlso}
\label{structcpu__id__t_aa453990e79712f02d887e552ef1d476b} 
...
CPU display (\"{}true\"{}) family (computed as Base\+Family[3\+:0]+Extended\+Family[7\+:0]) \label{structcpu__id__t_a1a27db236be904e2ed018ab31ae91486} 
...
CPU display (\"{}true\"{}) model (computed as (Extended\+Model[3\+:0]$<$$<$4) + Base\+Model[3\+:0]) For detailed discussion about what Base\+Model / Extended\+Model / Model are, see Github issue \#150. \label{structcpu__id__t_a538277e1ba0dcdacd1ced85ff707001e} 
...
CPU family (Base\+Family[3\+:0]) \label{structcpu__id__t_afe7f0f779b5986f1a89f02aa53d842a8} 
...
Features 
\end{DoxySeeAlso}
\label{structcpu__id__t_a486fed01524952d4487d092834e19466} 
...
\label{structcpu__id__t_a042eee2276b57355c66f8896d0ee141f} 
...
\label{structcpu__id__t_a170254ff9438d4af1a86744b7ca4817f} 
...
Cache associativity for the L1 data cache. -\/1 if undetermined \label{structcpu__id__t_a521f94f25038326af09bdaa560bb40be} 
...
L1 data cache size in KB. Could be zero, if the CPU lacks cache. If the size cannot be determined, it will be -\/1. \label{structcpu__id__t_ac83920fc5ae898b14041448dffdddc57} 
...
Cache-\/line size for L1 data cache. -\/1 if undetermined \label{structcpu__id__t_a856691cab0cf7be06239dbbe8e60ab7a} 
\index{cpu\_id\_t@{cpu\_id\_t}!l1\_data\_instances@{l1\_data\_instances}}
\index{l1\_data\_instances@{l1\_data\_instances}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{l1\_data\_instances}
{\footnotesize\ttfamily int32\+\_\+t cpu\+\_\+id\+\_\+t\+::l1\+\_\+data\+\_\+instances}

Number of L1 data cache instances. -\/1 if undetermined \label{structcpu__id__t_a2247e54fc475b2de0d01872b3583263a} 
...
Cache associativity for the L1 instruction cache. -\/1 if undetermined \label{structcpu__id__t_ae84b5ce3218be087a7202cc464c3b36b} 
...
\end{DoxyNote}
\label{structcpu__id__t_ac47ea6a2e28a6ca18a022a7015941a91} 
...
Cache-\/line size for L1 instruction cache. -\/1 if undetermined \label{structcpu__id__t_ad35795d5b7d54b8494c3043f538596bc} 
\index{cpu\_id\_t@{cpu\_id\_t}!l1\_instruction\_instances@{l1\_instruction\_instances}}
\index{l1\_instruction\_instances@{l1\_instruction\_instances}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{l1\_instruction\_instances}
{\footnotesize\ttfamily int32\+\_\+t cpu\+\_\+id\+\_\+t\+::l1\+\_\+instruction\+\_\+instances}

Number of L1 instruction cache instances. -\/1 if undetermined \label{structcpu__id__t_af3eb574f0137f0488613ea1476db3ec9} 
...
Cache associativity for the L2 cache. -\/1 if undetermined \label{structcpu__id__t_a1c25ec074eb46257c9a5cbe6fffd05dc} 
...
L2 cache size in KB. Could be zero, if the CPU lacks L2 cache. If the size of the cache could not be determined, it will be -\/1 \label{structcpu__id__t_a944cd9e0fe6a4106d02c99838c8e7ecd} 
...
Cache-\/line size for L2 cache. -\/1 if undetermined \label{structcpu__id__t_ac8addc3fda0b27e92debb1a3ffce6bae} 
\index{cpu\_id\_t@{cpu\_id\_t}!l2\_instances@{l2\_instances}}
\index{l2\_instances@{l2\_instances}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{l2\_instances}
{\footnotesize\ttfamily int32\+\_\+t cpu\+\_\+id\+\_\+t\+::l2\+\_\+instances}

Number of L2 cache instances. -\/1 if undetermined \label{structcpu__id__t_a607ddc319d790219bd4e9a8824f70731} 
...
Cache associativity for the L3 cache. -\/1 if undetermined \label{structcpu__id__t_a21a0da3e567614c4762c3e13bae0e6ad} 
...
L3 cache size in KB. Zero on most systems \label{structcpu__id__t_a1a05fc3dabc91ff18bac5b7b9fa06fc8} 
...
Cache-\/line size for L3 cache. -\/1 if undetermined \label{structcpu__id__t_a55594ff3b1d0469a78ec5c151aa0a5fd} 
\index{cpu\_id\_t@{cpu\_id\_t}!l3\_instances@{l3\_instances}}
\index{l3\_instances@{l3\_instances}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{l3\_instances}
{\footnotesize\ttfamily int32\+\_\+t cpu\+\_\+id\+\_\+t\+::l3\+\_\+instances}

Number of L3 cache instances. -\/1 if undetermined \label{structcpu__id__t_a3a680c01129926bc338be40c5f054f46} 
...
Cache associativity for the L4 cache. -\/1 if undetermined \label{structcpu__id__t_a06e8e373fa31aa5aa759c71b64e075db} 
...
L4 cache size in KB. Zero on most systems \label{structcpu__id__t_a9f6dc585f625a86f5ba545f1ea706af1} 
...
Cache-\/line size for L4 cache. -\/1 if undetermined \label{structcpu__id__t_adde07b038b9ea5d0fb4aa4fbf853f5a2} 
\index{cpu\_id\_t@{cpu\_id\_t}!l4\_instances@{l4\_instances}}
\index{l4\_instances@{l4\_instances}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{l4\_instances}
{\footnotesize\ttfamily int32\+\_\+t cpu\+\_\+id\+\_\+t\+::l4\+\_\+instances}

Number of L4 cache instances. -\/1 if undetermined \label{structcpu__id__t_abb6a0b806e88191ac428fc3d4b94930e} 
...
CPU model (Base\+Model[3\+:0]) \label{structcpu__id__t_ab2702b07ab0b424946a6c5525a06bfbe} 
...
Number of CPU cores on the current processor \label{structcpu__id__t_a052446102923b47cf859ffcf0f7c1845} 
...
Number of logical processors on the current processor. Could be more than the number of physical cores, e.\+g. when the processor has Hyper\+Threading. \label{structcpu__id__t_a5218527aa3a07edabe333bae788dd6cc} 
\index{cpu\_id\_t@{cpu\_id\_t}!purpose@{purpose}}
\index{purpose@{purpose}!cpu\_id\_t@{cpu\_id\_t}}
\doxysubsubsection{purpose}
{\footnotesize\ttfamily \textbf{ cpu\+\_\+purpose\+\_\+t} cpu\+\_\+id\+\_\+t\+::purpose}

processor type purpose, relevant in case of hybrid CPU (e.\+g. PURPOSE\+\_\+\+PERFORMANCE) \label{structcpu__id__t_a89b162728b0d5dbaf7b3169b2096ecbc} 
...
contains information about SGX features if the processor, if present \label{structcpu__id__t_ac8b6aff71ed7bab97f15194edac321fb} 
...
SSE execution unit size (64 or 128; -\/1 if N/A) \label{structcpu__id__t_a5ba98ac07e6ff6c1e99ee1f4726d9d3f} 
...
CPU stepping \label{structcpu__id__t_ae7ad9a6544e5fd9b5610824d1c66896e} 
...
\end{DoxyNote}
\label{structcpu__id__t_a531ac189d9462d9ecc8eb98e6a83eba5} 
...
contains the recognized CPU vendor \label{structcpu__id__t_a77b3f88a9f6fecdb61ed2d66be6244bd} 
...
contains the CPU vendor string, e.\+g. \"{}\+Genuine\+Intel\"{} 
