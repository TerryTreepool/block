...
impl ChunkView {
    // pub fn into_readonly(self) -> Self {
    //     match &self.0.state {
    //         ViewStateImpl::R(_) => self,
    //         ViewStateImpl::W(chunk) =>{
    //             let chunk = *chunk.write().unwrap();
    //             Self(Arc::new(ChunkViewImpl{
    //                 state: ViewStateImpl::R(chunk),
    //             }))
    //         }
    //     }
    // }
    ...
    //     match self.0.state {
    //         ViewStateImpl::W(chunk) => self,
    //         ViewStateImpl::R(chunk) =>{
    //             Self(Arc::new(ChunkViewImpl{
    //                 state: ViewStateImpl::W(RwLock::new(chunk)),
    //             }))
    //         }
    //     }
    // }
